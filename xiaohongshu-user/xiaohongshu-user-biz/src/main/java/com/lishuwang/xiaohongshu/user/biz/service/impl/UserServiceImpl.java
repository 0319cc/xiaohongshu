package com.lishuwang.xiaohongshu.user.biz.service.impl;
...
import com.lishuwang.framework.common.enums.DeletedEnum;
import com.lishuwang.framework.common.enums.StatusEnum;
...
import com.lishuwang.xiaohongshu.user.biz.constant.RedisKeyConstants;
import com.lishuwang.xiaohongshu.user.biz.constant.RoleConstants;
import com.lishuwang.xiaohongshu.user.biz.domain.dataobject.RoleDO;
import com.lishuwang.xiaohongshu.user.biz.domain.dataobject.UserDO;
import com.lishuwang.xiaohongshu.user.biz.domain.dataobject.UserRoleDO;
import com.lishuwang.xiaohongshu.user.biz.domain.mapper.RoleDOMapper;
import com.lishuwang.xiaohongshu.user.biz.domain.mapper.UserDOMapper;
import com.lishuwang.xiaohongshu.user.biz.domain.mapper.UserRoleDOMapper;
import com.lishuwang.xiaohongshu.user.biz.enums.ResponseCodeEnum;
import com.lishuwang.xiaohongshu.user.biz.enums.SexEnum;
import com.lishuwang.xiaohongshu.user.biz.model.vo.UpdateUserInfoReqVO;
import com.lishuwang.xiaohongshu.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.lishuwang.xiaohongshu.user.biz.rpc.OssRpcService;
import com.lishuwang.xiaohongshu.user.biz.service.UserService;
import com.lishuwang.xiaohongshu.user.biz.util.ParamUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        if (StringUtils.isNotBlank(xiaohongshuId)) {
            Preconditions.checkArgument(ParamUtils.checkXiaohongshuId(xiaohongshuId), ResponseCodeEnum.XIAOHASHU_ID_VALID_FAIL.getErrorMessage());
    ...
    /**
     * 根据用户 ID 查询用户信息, 被查询笔记的业务通过rpc调用
     *
