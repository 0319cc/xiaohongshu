...
import com.lishuwang.xiaohongshu.count.biz.enums.FollowUnfollowTypeEnum;
import com.lishuwang.xiaohongshu.count.biz.model.dto.CountFollowUnfollowMqDTO;
...
public class CountFansConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        // 更新 Redis  k 是用户id v是经过聚合后点赞个数(负数为取消点赞)
